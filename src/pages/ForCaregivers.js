...
import { Users, Activity, Baby, HeartPulse } from 'lucide-react';
    ...
    <div className="for-caregivers-page">
      ...
      <main className="fc-container">
        <section className={`fc-hero scroll-animate ${lang === 'ar' ? 'rtl-text' : ''}`}>
          <div className="fc-hero-tag">Trusted by 50,000+ Families</div>
          <h1 className="fc-hero-title">Because You Can't Be There Every Second.</h1>
          <p className="fc-hero-subtitle">Qlink gives caregivers the ultimate peace of mind. Know that your loved ones are protected, identified, and connected to help— even when you’re apart.</p>
          <button className="btn btn-primary fc-hero-action">Start Protecting Today</button>
        </section>
