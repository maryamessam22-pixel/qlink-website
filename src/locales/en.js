const translations = {
  ...
  emergencyPreview: {
    ...
    login: "Login",
    signUp: "Sign Up",
    heroBadge: "Emergency Info",
    heroSub: "This is the information first responders see<br />when scanning the QR code.",
    allergies: "Allergies",
    ...
    call: "Call",
    ctaTitle: "Stay Protected with",
    ctaText: "Qlink helps protect you and your loved ones by providing instant access to critical medical information during emergencies.",
  ...
  reviews: {
    ...
    addReviewRole: "Role or context (optional)",
    addReviewRolePlaceholder: "e.g. Parent, Runner, Caregiver",
    ...
    dbDetailCtaDesc: "Explore Qlink bracelets and set up your emergency profile.",
    dbDetailCtaBtn: "Shop the bracelet",
  ...
  auth: {
    ...
    supabaseErrorHint: "Hint: Change id type to UUID in Supabase.",
    btnArrow: "→",
    btnSignIn: "Sign In",
    btnSignUp: "Sign Up"
  },
  aiChat: {
    initialMessage: "Hello! I'm your Qlink AI Assistant. How can I help you today?",
    startTitle: "Start chatting",
    startSubtitle: "Please enter your name and email so we can help you with Qlink safety.",
    nameLabel: "Name",
    ...
    changeUserTitle: "Change name / email",
    clearHistory: "Clear Chat History",
    close: "Close Chat",
    botName: "Qlink Safety Bot",
    thinking: "Thinking...",
    inputPlaceholder: "Ask about Qlink safety...",
    confirmClearHistory: "Clear all chat history?",
    errors: {
      enterName: "Please enter your name.",
      enterEmail: "Please enter your email.",
      invalidEmail: "Please enter a valid email address.",
      sessionStartFailed: "Could not start session. Check Supabase policies.",
      generic: "Something went wrong. Please try again.",
      servicePrefix: "Service error: "
    }
  },
  completePurchase: {
