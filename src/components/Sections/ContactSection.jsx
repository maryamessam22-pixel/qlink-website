...
import { Send, Wrench, Book, MapPin, Mail, Phone } from 'lucide-react';
        ...
        <form onSubmit={(e) => e.preventDefault()}>
          <div className="form-row">
            <div className="form-group">
              ...
              <input type="text" className="form-control" placeholder={lang === 'ar' ? "أدخل اسمك" : "Enter your name"} />
            </div>
            <div className="form-group">
              <label>{t('supportCenter.formPhone')}</label>
              <input type="text" className="form-control" placeholder={lang === 'ar' ? "رقم الهاتف" : "Phone number"} />
            </div>
          </div>
          <div className="form-group">
          ...
          <div className="form-group">
            ...
            <textarea className="form-control" rows="4" placeholder={lang === 'ar' ? "كيف يمكننا مساعدتك؟" : "How can we help you?"}></textarea>
          </div>
